...
[![Tag](https://img.shields.io/github/tag/attestantio/go-eth2-client.svg)](https://github.com/MEV-HEPU/go-eth2-client/releases/)
[![License](https://img.shields.io/github/license/attestantio/go-eth2-client.svg)](LICENSE)
[![GoDoc](https://godoc.org/github.com/MEV-HEPU/go-eth2-client?status.svg)](https://godoc.org/github.com/MEV-HEPU/go-eth2-client)
![Lint](https://github.com/MEV-HEPU/go-eth2-client/workflows/golangci-lint/badge.svg)
[![Go Report Card](https://goreportcard.com/badge/github.com/MEV-HEPU/go-eth2-client)](https://goreportcard.com/report/github.com/MEV-HEPU/go-eth2-client)
...
```sh
go get github.com/MEV-HEPU/go-eth2-client
```
...
Please read the [Go documentation for this library](https://godoc.org/github.com/MEV-HEPU/go-eth2-client) for interface information.
...
import (
    ...
    "github.com/MEV-HEPU/go-eth2-client/http"
...
Contributions welcome. Please check out [the issues](https://github.com/MEV-HEPU/go-eth2-client/issues).
